...
| [#398](https://github.com/ENZYME-APD/tapir-archicad-automation/pull/398) | `ChangeWindow` — add optional `navigatorItemId` | 🟡 DRAFT — opened for direction review before validation pass | Branch `Yostage:feat/change-window-to-view`, commit `867ca5f`. Schema-additive, non-breaking. AC27+ routes through `ACAPI_View_GoToView`; AC25/26 falls back to plain database/window switch. |
